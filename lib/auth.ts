...
const LOGIN_URL = (process.env.BACKEND_URL || "") + (process.env.LOGIN_URL || "");
      ...
      async authorize(credentials, req) {
        ...
        try {
          ...
          if(data && data.access_token) {
            return {
              id: typeof credentials?.username === "string" ? credentials.username : "",
              name: typeof credentials?.username === "string" ? credentials.username : "",
              email: typeof credentials?.username === "string" ? credentials.username : "",
